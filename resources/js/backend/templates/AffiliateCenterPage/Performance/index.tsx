...
import { performanceChartData } from '@/backend/mocks/charts';
...
const Performance = () => {
    ...
    return (
        <Card title="Performance" selectValue={duration} selectOnChange={setDuration} selectOptions={durations}>
                ...
                <div className="h-84 max-md:h-76">
                    <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                            ...
                            <Tooltip content={<CustomTooltip payload={[]} />} cursor={{ stroke: 'var(--stroke-stroke2)' }} />
                            <Line
                                type="monotone"
                                dataKey="amt"
